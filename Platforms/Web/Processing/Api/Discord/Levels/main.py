...
@PhaazeWebIndex.view("/api/discord/levels{x:/?}{method:.*}")
async def apiDiscordLevels(cls:"PhaazebotWeb", WebRequest:ExtendedRequest) -> Response:
	"""
	Default url: /api/discord/levels{x:/?}{method:.*}
	"""
