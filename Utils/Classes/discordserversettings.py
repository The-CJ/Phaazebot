...
class DiscordServerSettings(DBContentClass):
	...
	def __init__(self, infos:dict = {}):
		...
		self.autorole:str = str( infos.get("autorole", Undefined()) )
		...
		self.blacklist_punishment:str = str( infos.get("blacklist_punishment", Undefined()) )
		self.currency_name:str = str( infos.get("currency_name", Undefined()) )
		self.currency_name_multi:str = str( infos.get("currency_name_multi", Undefined()) )
		...
		self.leave_chan:str = str( infos.get("leave_chan", Undefined()) )
		self.leave_msg:str = str( infos.get("leave_msg", Undefined()) )
		self.level_announce_channel:str = str( infos.get("level_announce_channel", Undefined()) )
		self.level_custom_message:str = str( infos.get("level_custom_message", Undefined()) )
		...
		self.server_id:str = str( infos.get("guild_id", Undefined()) )
		self.track_channel:str = str( infos.get("track_channel", Undefined()) )
		self.track_options:list = self.fromJsonField( infos.get("track_options", Undefined()) )
		self.welcome_chan:str = str( infos.get("welcome_chan", Undefined()) )
		self.welcome_msg:str = str( infos.get("welcome_msg", Undefined()) )
		self.welcome_msg_priv:str = str( infos.get("welcome_msg_priv", Undefined()) )
