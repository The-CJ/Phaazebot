...
@PhaazeWebIndex.view("/api/discord/configs{x:/?}{method:.*}")
async def apiDiscordConfigs(cls:"PhaazebotWeb", WebRequest:ExtendedRequest) -> Response:
	"""
	Default url: /api/discord/configs{x:/?}{method:.*}
	"""
